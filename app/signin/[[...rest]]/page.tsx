      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-12">
            <h1 className="font-satoshi font-black text-4xl md:text-5xl mb-4">WELCOME BACK</h1>
            <p className="font-inter text-lg text-gray-600">Sign in to continue converting your sheet music</p>
          </div>
