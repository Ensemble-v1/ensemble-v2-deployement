...
echo ""
echo -e "${YELLOW}⚠️  IMPORTANT: Choose UNIQUE service names!${NC}"
echo -e "${YELLOW}   The default names may already be taken.${NC}"
echo ""
echo -e "${GREEN}Suggested unique names (replace with your own):${NC}"
echo "  - Frontend: 'yourname-ensemble-frontend' or 'my-music-app-frontend'"
echo "  - Backend: 'yourname-ensemble-backend' or 'my-music-app-api'"
echo "  - Database: 'yourname-ensemble-db' or 'my-music-app-db'"
echo ""
echo -e "${GREEN}Frontend Configuration:${NC}"
echo "  - Name: [CHOOSE UNIQUE NAME - e.g., yourname-ensemble-frontend]"
echo "  - Runtime: Node"
...
echo "  - Name: [CHOOSE UNIQUE NAME - e.g., yourname-ensemble-backend]"
echo "  - Runtime: Node"
...
echo "  - Name: [CHOOSE UNIQUE NAME - e.g., yourname-ensemble-db]"
