...
echo ""
echo -e "${GREEN}Your pre-configured service names:${NC}"
echo "  - Frontend: 'ensemble-v1-frontend' (Free tier)"
echo "  - Backend: 'ensemble-v1-backend' (Starter tier - $7/month)"
echo ""
echo -e "${GREEN}Configuration Summary:${NC}"
echo "  - Frontend: Node.js, Free tier ($0/month)"
echo "  - Backend: Node.js, Starter tier ($7/month)"
echo "  - Total Cost: $7/month"
echo ""
